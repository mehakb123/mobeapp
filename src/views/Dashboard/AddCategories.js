    ...
    return (
        ...
        >
            {/* <Box>
                ...
                <Box mt='15%' fontSize='20px' border='1px solid #e7eaec' w='157%' padding='2px'>
                    ...
                    <Box>
                        ...
                        <Button
                            ...
                            onClick={() => {
                                ...
                                enable == true ? UpdateCategoriesApi() : CategoriesApi()
                            ...
                            {enable == true ? <Text>Edit Category</Text> : <Text>Add Category</Text>}
                        </Button>
                    </Box>
                </Flex>
